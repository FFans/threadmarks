...
abstract class ForumTestCase extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->prepareDatabase([
            'users' => [
                ['id' => 2, 'username' => 'reader', 'email' => 'reader@example.test', 'is_email_confirmed' => true, 'password' => 'test', 'joined_at' => '2026-01-01 00:00:00'],
                ['id' => 3, 'username' => 'author', 'email' => 'author@example.test', 'is_email_confirmed' => true, 'password' => 'test', 'joined_at' => '2026-01-01 00:00:00'],
                ['id' => 4, 'username' => 'moderator', 'email' => 'moderator@example.test', 'is_email_confirmed' => true, 'password' => 'test', 'joined_at' => '2026-01-01 00:00:00'],
            ],
            ...
            'discussions' => [
                ['id' => 1, 'title' => 'Author discussion', 'user_id' => 3, 'first_post_id' => 10, 'slug' => 'author-discussion', 'created_at' => '2026-01-01 00:00:00'],
                ['id' => 2, 'title' => 'Reader discussion', 'user_id' => 2, 'first_post_id' => 20, 'slug' => 'reader-discussion', 'created_at' => '2026-01-01 00:00:00'],
            ],
            'posts' => [
                ['id' => 10, 'discussion_id' => 1, 'number' => 1, 'user_id' => 3, 'created_at' => '2026-01-01 00:00:00', 'type' => 'comment', 'content' => '<t>Start</t>'],
                ['id' => 11, 'discussion_id' => 1, 'number' => 2, 'user_id' => 2, 'created_at' => '2026-01-01 00:00:00', 'type' => 'comment', 'content' => '<t>Reply</t>'],
                ['id' => 12, 'discussion_id' => 1, 'number' => 4, 'user_id' => 3, 'created_at' => '2026-01-01 00:00:00', 'type' => 'comment', 'content' => '<t>Reply after a gap</t>'],
                ['id' => 13, 'discussion_id' => 1, 'number' => 5, 'user_id' => 3, 'created_at' => '2026-01-01 00:00:00', 'type' => 'discussionRenamed', 'content' => '["old","new"]'],
                ['id' => 20, 'discussion_id' => 2, 'number' => 1, 'user_id' => 2, 'created_at' => '2026-01-01 00:00:00', 'type' => 'comment', 'content' => '<t>Start</t>'],
                ['id' => 21, 'discussion_id' => 2, 'number' => 2, 'user_id' => 3, 'created_at' => '2026-01-01 00:00:00', 'type' => 'comment', 'content' => '<t>Reply</t>'],
            ],
        ]);
    }
    ...
    protected function revoke(string $ability): void
    {
        ...
        // Flarum 1.x reloads actor permissions for each request.
    }
}
