...
import type LoadingPostComponent from 'flarum/forum/components/LoadingPost';
...
export default class ThreadmarkOnlyStream extends Component<ThreadmarkOnlyStreamAttrs> {
  ...
  private viewThreadmark(threadmark: Threadmark, index: number) {
    ...
    if (!post) {
      ...
      const LoadingPost = flarum.reg.get('core', 'forum/components/LoadingPost') as typeof LoadingPostComponent;
