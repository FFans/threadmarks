...
return [
    'up' => function (Builder $schema) {
        ...
        $schema->getConnection()->table('ffans_threadmark_types')->insert([
            ['key' => 'default', 'name' => 'Threadmark', 'color' => '#64748b', 'icon' => 'fa-solid fa-bookmark', 'position' => 1, 'is_builtin' => true],
            ['key' => 'notice', 'name' => 'Notice', 'color' => '#dc2626', 'icon' => 'fa-solid fa-bullhorn', 'position' => 2, 'is_builtin' => true],
