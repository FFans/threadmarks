...
GDPR is optional. Integration is enabled automatically when `flarum/gdpr` 1.8.2+ is enabled.
...
Want to help translate this extension? Visit Robert Korulczyk's [Weblate](https://weblate.rob006.net/projects/flarum/ffans-threadmarks).
